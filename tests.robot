...
Polling loopback can send and receive message
    ...
    ${tester} =  Create Terminal Tester  sysbus.uart4
...
Two controllers can communicate across CANHub
    ...
    ${tester1} =  Create Terminal Tester  sysbus.uart4  machine=receiver1
    ${tester2} =  Create Terminal Tester  sysbus.uart4  machine=receiver2
